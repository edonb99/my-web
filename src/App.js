        ...
        <div className="App">
            <div className=''>
                ...
                <div className='section-container'>
                 ...
                 <div className='section-container'>
                    <Photo style={{width: '33.33%'}}  p={'Article'} h1={'The Threat of a Nuclear Iran'} logo={'https://cms.outrider.org/sites/default/files/styles/near_square_md/public/2018-02/ARC_CL_BQ_GTY_868691436_master.jpg?h=c95bc20e&itok=8N3mEkpc'}/>
                    <Photo style={{width: '33.33%'}}  p={'Article'} h1={'North Korea on the Brink'} logo={'https://cms.outrider.org/sites/default/files/styles/near_square_md/public/2018-02/ARC_CL_BQ_GTY_851817428_master.jpg?h=b1dadf27&itok=ZTk5pIz7'} />
                    <Photo style={{width: '33.33%'}}  p={'Article'} h1={'Will India and Pakistan’s Conflict Go Nuclear?'} logo={'https://cms.outrider.org/sites/default/files/styles/near_square_md/public/2018-02/ARC_CL_BQ_GTY_498922226_master.jpg?h=cb0d593c&itok=zYqAzruU'} />
                 </div>
