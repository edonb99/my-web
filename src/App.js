            ...
            <div className=''>
                ...
                />
                 ...
                 style={{ padding:'80px', 'grid-column':'span 3', order:'10'}}
                    />
{/*
                    <Photo style={{'grid-column':'span 1', order:'10'}} />

                    <Photo style={{'grid-column':'span 1' , order:'11' }} />
                    <Photo style={{'grid-column':'span 1', order:'12'}} />
                    <Photo style={{'grid-column':'span 1', order:'13'}} />
*/}
</div>
</div>
        </div>
